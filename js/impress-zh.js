/**
 * =======================================================================================
 * This is a fork of great project impress.js
 *
 * original by Bartek Szopka (@bartaz) available here: http://github.com/bartaz/impress.js/
 * this fork by Zuzana Harcarikova (@zuzana) available here: https://github.com/zuzana/impress.js/
 *
 * purpose: created as a quick workaround to be used togehter with Backbone.js router
 * future:  I might delete it once I find more elegant way to put up with hashchange
 *
 * Original comments by Bartek Szopka were preserved. Mine are preceded by string "(ZH:)".
 * =======================================================================================
 *
 * impress.js
 *
 ...
 *
 *
 * Copyright 2013 Zuzana Harcarikova (@zuzana)
 *
 * Released under the MIT and GPL Licenses.
 *
 * ------------------------------------------------
 *  author:  Zuzana Harcarikova
 *  version: 0.0.1
 *  source:  https://github.com/zuzana/impress-zh
 */
...
(function ( document, window ) {
    ...
    console.log("?impressSupported? " + impressSupported);
    ...
    var impress = window.impress = function ( rootId ) {
        ...
        var init = function () {
            ...
            //(ZH:2)
            //TODO:
            var lastSlash = window.location.hash.lastIndexOf("/");
            var tempBaseHash = window.location.hash;
            if (lastSlash !== -1){
                baseHash = tempBaseHash.substr(0, lastSlash);
            } else {
                baseHash = tempBaseHash;
            }
            lastHash = baseHash;
        ...
        root.addEventListener("impress:init", function(){
            ...
            root.addEventListener("impress:stepenter", function (event) {
                //(ZH:)
                window.location.hash = lastHash = baseHash + "/" + event.target.id;
            }, false);
...
(function ( document, window ) {
    ...
    //(ZH:4) Because of compatibility mode had to add this one if.
